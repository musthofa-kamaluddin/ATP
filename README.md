...
- **Modul 2: Perulangan, Array, dan String**
  - Perulangan (`for`, `while`, `do-while`), Array 1D/2D, & Pengolahan String
- **Modul 3: Fungsi dan Rekursi**
  - Deklarasi/Definisi Fungsi, Parameter, & Konsep Rekursi
- **Modul 4: Pointer dan Struct**
  - Operasi Pointer, Memory Address, & Tipe Data Terstruktur (`struct`)
